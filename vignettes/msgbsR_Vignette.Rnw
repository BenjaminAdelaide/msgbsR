...
@
\end{center}
\caption{A circos plot of chromosome 22 representing the top 100 differentially methylated cut sites.}
\label{fig:fig2}
\end{figure}
...
@
\end{center}
\caption{A karyogram of chromosome 22 showing the location of differentially methylated cut sites.}
\label{fig:fig3}
\end{figure}
