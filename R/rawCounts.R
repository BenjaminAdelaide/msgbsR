#' rawCounts
#'
#' Import the raw reads counts from a sorted and indexed bam file
#' @param bamFilePath The path to the location of bam file(s)
#' @return a data frame of read counts where rows are cut sites and columns are samples
#' @export
...
rawCounts <- function(bamFilepath, threads){
